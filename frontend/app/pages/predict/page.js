      ...
      if(data?.predicted_result === 'no tumor') {
        ...
        MySwal.fire({
          html: `
            ...
            <p style="font-size: 27px; margin-top: 10px;"> The uploaded image of the brain has no tumor and the model made this prediction with a confidence of ${
            data?.confidence
          }</p>
        ...
        MySwal.fire({
          html: `
            ...
            } tumor and the model made this prediction with a confidence of ${
            data?.confidence
          }</p>
